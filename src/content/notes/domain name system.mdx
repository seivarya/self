...
is what we call a DNS server. The flow is simple:
...
We could even intercept and block the response `8.8.8.8` 
...
similarly to malicious users our ISPs can also see the queries our stub
resolver sends. So how do we solve this issue? There is 
something called DoH [DNS over HTTPS]. We know HTTPS is the secure version of 
HTTP that lets us see websites in a secure manner and hackers can't see what 
