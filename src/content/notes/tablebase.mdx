...
A **tablebase** is a mathematical database that says any position with 7 or fewer pieces on the board is a solvable state.  
...
(How it decides which is the best move is a whole other story.)  
